                    ...
                    switch(r) {
                        ...
                        case "strict_include":
                            ...
                            if(!found) {
                                ...
                                throw new Error(
                                    "Requested file <"+nfile+"> could not be resolved."
                                    +"\n Path: "+innerOpts.include_path.join(" : "));
                            }
                            ...
                            if(rfile in state.included) {
                                ...
                                // Run a function to allow custom stuff.
                                if(innerOpts.onInclude) innerOpts.onInclude(rfile);
                            }
                        break;
                        case "ifdef":
